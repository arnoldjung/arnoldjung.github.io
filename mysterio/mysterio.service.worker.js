...
/** @type {string} */
const CACHE_VERSION = '1741742160|1033628471';
/** @type {string} */
const CACHE_PREFIX = 'official_tutoria-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mysterio.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mysterio.html","mysterio.js","mysterio.offline.html","mysterio.icon.png","mysterio.apple-touch-icon.png","mysterio.audio.worklet.js","mysterio.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["mysterio.wasm","mysterio.pck"];
