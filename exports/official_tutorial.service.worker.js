...
/** @type {string} */
const CACHE_VERSION = '1741739816|366454028588';
/** @type {string} */
const CACHE_PREFIX = 'official_tutoria-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'official_tutorial.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["official_tutorial.html","official_tutorial.js","official_tutorial.offline.html","official_tutorial.icon.png","official_tutorial.apple-touch-icon.png","official_tutorial.audio.worklet.js","official_tutorial.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["official_tutorial.wasm","official_tutorial.pck"];
